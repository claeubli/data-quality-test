CREATE OR REPLACE PROCEDURE `{{params.destination_project}}`.`{{ params.destination_dataset }}.data_freshness`(
    ...
    OPTIONS ( DESCRIPTION = "This procedure will create a temporary table containing the records for each table in a dataset that wasn't modified in the last 24 hours" )
